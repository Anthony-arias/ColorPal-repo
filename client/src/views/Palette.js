  ...
  return (
      <div >
          <Container>
              {loaded && (
                  <div>
                      <Column style={{ backgroundColor: "#" + currentColors[0] }}></Column>
                      <Column style={{ backgroundColor: "#" + currentColors[1] }}></Column>
                      <Column style={{ backgroundColor: "#" + currentColors[2] }}></Column>
                      <Column style={{ backgroundColor: "#" + currentColors[3] }}></Column>
                      <Column style={{ backgroundColor: "#" + currentColors[4] }}></Column>
